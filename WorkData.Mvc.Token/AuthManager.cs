...
namespace WorkData.Mvc.Token
{
    ...
    public static class AuthManager
    {
        ...
        /// <returns></returns>
        internal static bool TryAuthorize(AuthorizationContext context, string token, params string[] roles)
        {
            // 匿名访问验证
        ...
        /// </summary>
        /// <returns></returns>
        internal static string GetToken(AuthorizationContext context)
        {
             return context.HttpContext.Request.QueryString[AUTH_TOKEN];
        }

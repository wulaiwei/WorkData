...
namespace System.Data.Entity.Future
{
    ...
    /// <example>
    /// The following is an example of how to use FutureValue.
    /// <code><![CDATA[
    ...
    public class FutureValue<T> : FutureQueryBase<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:System.Data.Entity.Future.FutureValue`1" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T:System.Data.Entity.Future.FutureValue`1" /> to T.
        /// </summary>

...
namespace System.Data.Entity.Future
{
    /// <summary>
    ...
    public class FutureContext : IFutureContext
    {
        ...
        public FutureContext(ObjectContext objectContext)
        {
            ...
            FutureQueries = new List<IFutureQuery>();
        }
        ...
        /// The future queries.
        /// </value>
        public IList<IFutureQuery> FutureQueries { get; }
        ...
        public void ExecuteFutureQueries()
        {
            ...
            if (context == null)
                throw new ObjectDisposedException("ObjectContext",
                    "The ObjectContext for the future queries has been displosed.");

            var runner = Locator.Current.Resolve<IFutureRunner>();
            if (runner == null)
                throw new InvalidOperationException(
                    "Could not resolve the IFutureRunner. Make sure IFutureRunner is registered in the Locator.Current container.");

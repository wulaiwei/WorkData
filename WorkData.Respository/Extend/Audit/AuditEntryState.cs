    ...
    internal class AuditEntryState
    {
        public AuditEntryState(ObjectContext objectContext, ObjectStateEntry objectStateEntry)
        {
            ...
            if (objectStateEntry.Entity == null)
                throw new ArgumentException("The Entity property is null for the specified ObjectStateEntry.",
                    "objectStateEntry");
            ...
            EntityType =
                objectContext.MetadataWorkspace.GetItems(DataSpace.OSpace)
                    .OfType<EntityType>()
        ...
        public AuditEntity AuditEntity { get; }

...
using System.Data.Entity.Reflection;
using System.Linq;
...
namespace System.Data.Entity.Batch
{
    /// <summary>
    ...
    public class OracleBatchRunner : IBatchRunner
    {
        ...
        /// The number of rows deleted.
        /// </returns>
        public Task<int> DeleteAsync<TEntity>(ObjectContext objectContext, EntityMap entityMap,
        ...
        /// </returns>
        public int Update<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query,
        ...
        /// The number of rows updated.
        /// </returns>
        public Task<int> UpdateAsync<TEntity>(ObjectContext objectContext, EntityMap entityMap,
            ObjectQuery<TEntity> query, Expression<Func<TEntity, TEntity>> updateExpression) where TEntity : class
        {
...
#if NET45
        private async Task<int> InternalDelete<TEntity>(ObjectContext objectContext, EntityMap entityMap,
            ObjectQuery<TEntity> query, bool async = false)
            where TEntity : class
#else
...
#endif
        {
            ...
            try
            {
                InitializeConnectionAndTransaction(objectContext, ref deleteConnection, ref deleteTransaction,
                    ref ownConnection, ref ownTransaction);
...
#if NET45
        private async Task<int> InternalUpdate<TEntity>(ObjectContext objectContext, EntityMap entityMap,
            ObjectQuery<TEntity> query, Expression<Func<TEntity, TEntity>> updateExpression, bool async = false)
            where TEntity : class
#else
...
#endif
        {
            ...
            try
            {
                InitializeConnectionAndTransaction(objectContext, ref updateConnection, ref updateTransaction,
                    ref ownConnection, ref ownTransaction);
                ...
                using (var updateCommand = CreateCommand(objectContext, updateConnection, updateTransaction))
                {
                    ...
                    var sqlBuilder = BuildUpdateSql<TEntity>(objectContext, entityMap, updateCommand, innerSelect,
        ...
        private static void InitializeConnectionAndTransaction(ObjectContext objectContext, ref DbConnection connection,
            ref DbTransaction transaction, ref bool ownConnection, ref bool ownTransaction)
        {
        ...
        private static DbCommand CreateCommand(ObjectContext objectContext, DbConnection connection,
        ...
        private static void ReleaseConnectionAndTransaction(DbConnection connection, DbTransaction transaction,
            bool ownConnection, bool ownTransaction)
        {
        ...
        #endregion Connection & Transaction Management

        #region Update Helpers

        private static StringBuilder BuildUpdateSql<TEntity>(ObjectContext objectContext, EntityMap entityMap,
            DbCommand updateCommand, string innerSelect, MemberInitExpression memberInitExpression)
            where TEntity : class
        {
            var nameCount = 0;
            var wroteSet = false;
            ...
            foreach (var binding in memberInitExpression.Bindings)
            {
                ...
                if (memberAssignment == null)
                {
                    throw new ArgumentException(
                        "The update expression MemberBinding must only by type MemberAssignment.", "updateExpression");
                }
                ...
                var columnName = entityMap.PropertyMaps.Where(p => p.PropertyName == propertyName)
                ...
                {
                    nameCount = BuildUpdateParameterWithExpression(updateCommand, fieldsToUpdate, valuesToUpdate,
                        nameCount, columnName, memberExpression);
                }
                else
                {
                    nameCount = BuildUpdateParameterWithoutExpression<TEntity>(objectContext, entityMap, updateCommand,
                        fieldsToUpdate, valuesToUpdate, nameCount, columnName, memberExpression, parameterExpression);
                }
        ...
        private static int BuildUpdateParameterWithExpression(DbCommand updateCommand, StringBuilder fieldsToUpdate,
            StringBuilder valuesToUpdate, int nameCount, string columnName, Expression memberExpression)
        {
            object value;
        ...
        private static int BuildUpdateParameterWithoutExpression<TEntity>(ObjectContext objectContext,
            EntityMap entityMap, DbCommand updateCommand, StringBuilder fieldsToUpdate, StringBuilder valuesToUpdate,
            int nameCount, string columnName, Expression memberExpression, ParameterExpression parameterExpression)
            where TEntity : class
        {
            ...
            var selectExpression = Expression.Call(typeof(Queryable), "Select", typeArguments, constantExpression,
                lambdaExpression);
            ...
            if (!match.Success)
            {
                throw new ArgumentException("The MemberAssignment expression could not be processed.",
                    "updateExpression");
            }

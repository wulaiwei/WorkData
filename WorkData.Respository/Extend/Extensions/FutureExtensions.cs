...
using System.Data.Entity.Future;
using System.Linq;
...
namespace System.Data.Entity.Extensions
{
    ...
    /// </summary>
    /// <seealso cref="T:System.Data.Entity.Future.FutureQuery`1" />
    /// <seealso cref="T:System.Data.Entity.Future.FutureValue`1" />
    /// <seealso cref="T:System.Data.Entity.Future.FutureCount" />
    public static class FutureExtensions
    {
            ...
            where TEntity : class
        {
            ...
            var countQuery = sourceQuery.CreateQuery(expression, typeof(int));
            if (countQuery == null)
                throw new ArgumentException("The source query must be of type ObjectQuery or DbQuery.", "source");
        ...
        /// The type of the result value wrapped in a
        /// <see cref="T:System.Data.Entity.Future.FutureValue`1" />.
        /// </typeparam>
        /// <param name="source">An <see cref="T:System.Linq.IQueryable`1" /> to add to the batch of future queries.</param>
        /// <param name="selector">A lambda expression with one of the Min, Max, Count, Sum, Average aggregate functions</param>
        /// <returns>An instance of <see cref="T:System.Data.Entity.Future.FutureValue`1" /> that contains the result of the query</returns>
        public static FutureValue<TResult> FutureValue<TEntity, TResult>(this IQueryable<TEntity> source,
            Expression<Func<IQueryable<TEntity>, TResult>> selector)
            where TEntity : class
        {
            if (source == null)
            ...
            if (methodExpr == null || methodExpr.Arguments.Count == 0)
                throw new ArgumentException(
                    "The body of lambda expression must be a Count, Min, Max, Sum or Average method call", "selector");
            ...
            where TEntity : class
        {
            ...
            var objectQuery = firstQuery.ToObjectQuery();
            if (objectQuery == null)
                throw new ArgumentException("The source query must be of type ObjectQuery or DbQuery.", "source");

...
using System.Data.Entity.Caching;
using System.Linq;
...
namespace System.Data.Entity.Extensions
{
    ...
    public static class CacheExtensions
    {
        ...
        public static IEnumerable<TEntity> FromCache<TEntity>(this IQueryable<TEntity> query,
            CachePolicy cachePolicy = null, IEnumerable<string> tags = null)
            where TEntity : class
        {
        ...
        /// The result of the query.
        /// </returns>
        public static async Task<IEnumerable<TEntity>> FromCacheAsync<TEntity>(this IQueryable<TEntity> query,
            CachePolicy cachePolicy = null, IEnumerable<string> tags = null)
            where TEntity : class
        {
            var key = query.GetCacheKey();
        ...
        public static TEntity FromCacheFirstOrDefault<TEntity>(this IQueryable<TEntity> query,
            CachePolicy cachePolicy = null, IEnumerable<string> tags = null)
            where TEntity : class
        {
            return query
        ...
        /// <param name="tags">The list of tags to use for cache expiration.</param>
        /// <returns>default(T) if source is empty; otherwise, the first element in source.</returns>
        public static async Task<TEntity> FromCacheFirstOrDefaultAsync<TEntity>(this IQueryable<TEntity> query,
            CachePolicy cachePolicy = null, IEnumerable<string> tags = null)
            where TEntity : class
        {
            var q = await query
        ...
        /// </returns>
        public static IQueryable<TEntity> RemoveCache<TEntity>(this IQueryable<TEntity> query,
            out IEnumerable<TEntity> removed)
            where TEntity : class
        {
            var key = query.GetCacheKey();

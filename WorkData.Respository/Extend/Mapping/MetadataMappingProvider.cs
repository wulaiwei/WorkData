...
namespace System.Data.Entity.Mapping
{
    ...
    public class MetadataMappingProvider : IMappingProvider
    {
        ...
        public EntityMap GetEntityMap(Type type, ObjectContext objectContext)
        {
            ...
            var entityType =
                metadata.GetItems<EntityType>(DataSpace.OSpace).Single(e => objectItemCollection.GetClrType(e) == type);
        ...
        private static void SetTableName(EntityMap entityMap)
        {
            ...
            {
                storeSet.MetadataProperties.TryGetValue(
                    "http://schemas.microsoft.com/ado/2007/12/edm/EntityStoreSchemaGenerator:Table",

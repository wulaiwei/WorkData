...
namespace System.Data.Entity.Reflection
{
    ...
    public static class ObjectCopier
    {
        ...
        /// A delegate to determine if the property name should be ignored.
        /// When the delegate returns true, the property will not be set in the target.
        /// </param>
        /// <param name="suppressExceptions">If <see langword="true" />, any exceptions will be suppressed.</param>
        /// <remarks>
        /// <para>
        ...
        #endregion Copy Object To Object
        ...
        /// <param name="ignoreList">
        /// A list of property names to ignore.
        /// These properties will not be added to the targeted <see cref="IDictionary" />.
        /// </param>
        ...
        /// </param>
        /// <param name="suppressExceptions">If <see langword="true" />, any exceptions will be suppressed.</param>
        public static void Copy(object source, IDictionary<string, object> target, bool suppressExceptions,
        ...
        /// <param name="propertyFilter">
        /// A delegate to determine if the property name should be ignored.
        /// When the delegate returns true, the property will not be added to the targeted <see cref="IDictionary" />.
        /// </param>
        /// <param name="suppressExceptions">If <see langword="true" />, any exceptions will be suppressed.</param>
        public static void Copy(object source, IDictionary<string, object> target, bool suppressExceptions,
        ...
        #endregion Copy Object to IDictionary<string, object>
        ...
        /// </param>
        /// <param name="suppressExceptions">If <see langword="true" />, any exceptions will be suppressed.</param>
        public static void Copy(NameValueCollection source, object target, bool suppressExceptions,
            params string[] ignoreList)
        {
        ...
        #endregion Copy From NameValueCollection to Object
        ...
        /// </param>
        /// <param name="suppressExceptions">If <see langword="true" />, any exceptions will be suppressed.</param>
        public static void Copy(IDictionary<string, object> source, object target, bool suppressExceptions,
            params string[] ignoreList)
        {
            var ignore = new HashSet<string>(ignoreList ?? new string[0]);
            Copy(source, target, suppressExceptions, ignore.Contains);
        ...
        #endregion Copy IDictionary<string, object> to Object
    }
}
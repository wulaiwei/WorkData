...
namespace System.Data.Entity.Reflection
{
    ...
    public static class ReflectionHelper
    {
        ...
        /// <param name="propertyExpression">The property expression.</param>
        /// <returns>The <see cref="PropertyInfo" /> from the expression.</returns>
        public static PropertyInfo ExtractPropertyInfo<TSource, TValue>(
        ...
        {
            var t = type;
            var isNullable = t.IsGenericType && (t.GetGenericTypeDefinition() == _nullableType);
            if (isNullable)
        ...
        public static object CoerceValue(Type desiredType, Type valueType, object value)
        {
            ...
            var isNullable = desiredType.IsGenericType && (desiredType.GetGenericTypeDefinition() == _nullableType);
            if (isNullable)
            {
                if (value == null)
                    return null;
            ...
            var isBinary = desiredType.IsArray && desiredType.Equals(_byteArrayType);
